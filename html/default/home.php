			...
			<div class="container">
				...
				<div class="main">
					...
					<section class="cols">
						...
						<div class="col">
							...
							<div class="col-cnt">
								<h2>Ordering</h2>
								<p>Want to own a high quality sports apparel?</p>
								<a href="#" class="more">Order Now!</a>
							</div>
						</div>
						<div class="col">
				...
				<div id="footer">
					...
					<div class="footer-bottom">
						...
						<p class="copy">&copy; Copyright 2014 Stargame Sportswear<span>|</span> <strong>Powered by <a href="sad0108.php" target="_blank">SAD0108</a></strong></p>
						<div class="cl">&nbsp;</div>
					</div>
				</div>
			</div>
